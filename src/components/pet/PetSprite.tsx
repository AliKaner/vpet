...
export function PetSprite({ species, appearance, clothingId, pose = "idle", emotion = "content", small = false, onComplete }: {
  species: SpeciesId; appearance?: string; clothingId?: string; pose?: PetPose; emotion?: PetEmotion; small?: boolean; onComplete?: () => void;
}) {
