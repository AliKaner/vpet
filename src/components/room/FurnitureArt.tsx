...
export function FurnitureArt({ id }: { id: string }) {
  ...
  if (cell !== undefined) return <span className="furniture-pixel-art" aria-hidden="true" style={{ backgroundPosition:`${cell%4*100/3}% ${Math.floor(cell/4)*100/3}%`, transform:id === "furniture_rug" ? "scaleY(.55)" : undefined, transformOrigin:"50% 76%" }} />;
