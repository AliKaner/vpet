...
export function PetHomePage({ pet, embedded = false, roomIndex = 0, roomPetCount = 1 }: { pet: ActivePet; embedded?: boolean; roomIndex?: number; roomPetCount?: number }) {
