...
test('room atlases preserve alpha at delivery resolution and stay within download budget',async()=>{
  ...
  const sources=['public/assets/pets/room-isometric-v2.png','public/assets/pets/room-themes-v1.png','public/assets/pets/room-styles-v1.png','public/assets/pets/room-garden-v1.png'];
  ...
  for(const [i,url] of urls.entries()) {
    ...
    assert.ok((await readFile('index.html','utf8')).includes(`href="${url}" fetchpriority="high"`));
  }
